...
def run_attacks(yaml_path, attack_obj_save_path, functions):
    ...
    attack_constructor_map = {
        ...
        "DDNAttack": foolbox_wrapper.DDNAttack,
        "L2ProjectedGradientDescentAttack": foolbox_wrapper.L2ProjectedGradientDescentAttack,
        "LinfProjectedGradientDescentAttack": foolbox_wrapper.LinfProjectedGradientDescentAttack,
        "L2BasicIterativeAttack": foolbox_wrapper.L2BasicIterativeAttack,
        "LinfBasicIterativeAttack": foolbox_wrapper.LinfBasicIterativeAttack,
        "L2FastGradientAttack": foolbox_wrapper.L2FastGradientAttack,
        "LinfFastGradientAttack": foolbox_wrapper.LinfFastGradientAttack,
        "L2AdditiveGaussianNoiseAttack": foolbox_wrapper.L2AdditiveGaussianNoiseAttack,
        "L2AdditiveUniformNoiseAttack": foolbox_wrapper.L2AdditiveUniformNoiseAttack,
        "L2ClippingAwareAdditiveGaussianNoiseAttack": foolbox_wrapper.L2ClippingAwareAdditiveGaussianNoiseAttack,
        "L2ClippingAwareAdditiveUniformNoiseAttack": foolbox_wrapper.L2ClippingAwareAdditiveUniformNoiseAttack,
        "L2RepeatedAdditiveGaussianNoiseAttack": foolbox_wrapper.L2RepeatedAdditiveGaussianNoiseAttack,
        "L2RepeatedAdditiveUniformNoiseAttack": foolbox_wrapper.L2RepeatedAdditiveUniformNoiseAttack,
        "L2ClippingAwareRepeatedAdditiveGaussianNoiseAttack": foolbox_wrapper.L2ClippingAwareRepeatedAdditiveGaussianNoiseAttack,
        "L2ClippingAwareRepeatedAdditiveUniformNoiseAttack": foolbox_wrapper.L2ClippingAwareRepeatedAdditiveUniformNoiseAttack,
        "LinfAdditiveUniformNoiseAttack": foolbox_wrapper.LinfAdditiveUniformNoiseAttack,
        "LinfRepeatedAdditiveUniformNoiseAttack": foolbox_wrapper.LinfRepeatedAdditiveUniformNoiseAttack,
        "InversionAttack": foolbox_wrapper.InversionAttack,
        "BinarySearchContrastReductionAttack": foolbox_wrapper.BinarySearchContrastReductionAttack,
        "LinearSearchContrastReductionAttack": foolbox_wrapper.LinearSearchContrastReductionAttack,
        "L2CarliniWagnerAttack": foolbox_wrapper.L2CarliniWagnerAttack,
        "NewtonFoolAttack": foolbox_wrapper.NewtonFoolAttack,
        "EADAttack": foolbox_wrapper.EADAttack,
        "GaussianBlurAttack": foolbox_wrapper.GaussianBlurAttack,
        "L2DeepFoolAttack": foolbox_wrapper.L2DeepFoolAttack,
        "LinfDeepFoolAttack": foolbox_wrapper.LinfDeepFoolAttack,
        "SaltAndPepperNoiseAttack": foolbox_wrapper.SaltAndPepperNoiseAttack,
        "LinearSearchBlendedUniformNoiseAttack": foolbox_wrapper.LinearSearchBlendedUniformNoiseAttack,
        "BinarizationRefinementAttack": foolbox_wrapper.BinarizationRefinementAttack,
        "BoundaryAttack": foolbox_wrapper.BoundaryAttack,
        "L0BrendelBethgeAttack": foolbox_wrapper.L0BrendelBethgeAttack,
